                    ...
                    <div className="relative bg-black border border-red-900/60 p-8 space-y-6">
                        ...
                        <form onSubmit={handleAuthenticate} noValidate className="space-y-5">
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="text"
                                            className="w-full pl-10 pr-4 py-3 bg-slate-950 border border-slate-800 text-slate-200 font-mono text-sm placeholder:text-slate-700 focus:outline-none focus:border-red-500"
                            ...
                            >
                                ...
                                <div className="relative bg-black border border-red-700/50 px-6 py-3">
