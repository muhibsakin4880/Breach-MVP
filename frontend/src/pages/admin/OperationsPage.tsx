...
export default function OperationsPage({
    title = 'Operations',
    subtitle = 'Protected evaluation environments, residency posture, and pilot readiness blockers'
    ...
    const summaryCards = [
        {
            ...
            detail: 'Review environments currently tracked for pilot approval and signoff.'
        },
        {
            ...
            <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-between gap-3">
                            <div>
                                ...
                                <p className="mt-1 text-[10px] leading-relaxed text-slate-500">
                                    Deployment mode, residency posture, evidence state, and the current blocker for each active pilot review.
                                </p>
                            </div>
                            <Link
                    ...
                    <section className="col-span-4 rounded-xl border border-slate-800/50 bg-slate-900/60 p-5 shadow-2xl shadow-black/30 backdrop-blur-xl">
                        <div className="flex items-center justify-between gap-3">
                            <div>
                                ...
                                <p className="mt-1 text-[10px] leading-relaxed text-slate-500">
                                    The blockers most likely to delay pilot approval or regional deployment readiness.
                                </p>
                            </div>
                            <Link
                ...
                <div className="grid grid-cols-12 gap-5">
                    <section className="col-span-7 rounded-xl border border-slate-800/50 bg-slate-900/60 p-5 shadow-2xl shadow-black/30 backdrop-blur-xl">
                        ...
                        <p className="mt-1 text-[10px] leading-relaxed text-slate-500">
                            The infrastructure baseline may vary by platform, but the pilot review logic and evidence requirements remain consistent.
                        </p>
