    ...
    const summaryCards = [
        {
            ...
            detail: 'Cross-linked review, incident, and signoff events held in the admin evidence ledger.'
        },
        {
            label: 'Verified Events',
            value: verifiedCount.toString(),
            detail: 'Events ready to support signoff, incident closure, or pilot readiness conversations.'
        },
        {
            label: 'Exceptions',
