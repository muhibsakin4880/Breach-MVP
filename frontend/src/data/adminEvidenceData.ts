...
export const responsibilityLanes: ResponsibilityLane[] = [
    ...
    },
    {
        ...
        controls: ['Jurisdiction and residency signoff', 'Named reviewer ownership', 'Pilot-scope acceptance and internal legal approval']
    }
]
...
export const evidencePacks: EvidencePack[] = [
    ...
    },
    {
        ...
        name: 'Utilities pilot evidence pack',
        scope: 'Shared-responsibility controls, telemetry handling plan, export rules, pilot scope.',
        owner: 'Layla Haddad',
        status: 'Ready',
        updatedAt: 'Mar 31, 2026 · 08:20',
        contents: ['Control split note', 'Evidence handling matrix', 'Pilot scope memo', 'Approval-chain summary']
    },
    {
        id: 'EVP-2293',
        reviewId: 'APP-2293',
...
export const adminVisibilityBoundaries: VisibilityBoundary[] = [
    ...
    },
    {
        ...
        detail: 'Evidence packs summarize what matters for signoff without turning the admin console into a raw-data browser.',
        visibleToAdmins: 'Evidence bundle contents, hashes, signoff notes, and exception summaries.',
...
export const incidentRunbook: IncidentRunbookStep[] = [
    ...
    },
    {
        ...
        detail: 'Add the incident summary, disposition, and remediation notes to the active pack before signoff resumes.',
        status: 'pending'
    },
    {
        step: 'Step 5',
...
export const deploymentSurfaces: DeploymentSurface[] = [
    ...
    },
    {
        ...
        evaluationStatus: 'Workspace ready for signoff.',
...
export const approvalBlockers: ApprovalBlocker[] = [
    ...
    },
    {
        ...
        reviewId: 'APP-4471',
        organization: 'Pinnacle Systems',
        blocker: 'One policy comment still needs closure before signoff.',
        owner: 'Layla Haddad',
