...
const menuSections: MenuSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Incidents', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z', path: '/admin/incident-response' }
        ]
    }
]
                ...
                <nav className="flex-1 overflow-y-auto px-3 pb-4">
                    {menuSections.map((section) => (
                        <div key={section.heading} className="mb-5">
                            <div className="px-3 pb-2 pt-1 text-[9px] font-semibold uppercase tracking-[0.16em] text-slate-600">
                                {section.heading}
                            </div>
                            <div className="space-y-1">
                                {section.items.map((item) => (
                                    <button
                                        ...
                                        className={`w-full flex items-center gap-3 px-3 py-2.5 text-[11px] font-medium tracking-wide transition-all duration-200 rounded-lg text-left ${
                                            isActive(item.path || '')
